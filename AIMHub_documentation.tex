...
% Change-review mode. tex_review.bat defines \AIMHubReview before loading
% this file; the normal tex.bat build leaves the marked text black.
\newif\ifAIMHubReviewMode
\ifdefined\AIMHubReview
  \AIMHubReviewModetrue
\else
  \AIMHubReviewModefalse
\fi
\newcommand{\changed}[1]{\ifAIMHubReviewMode{\color{red}#1}\else#1\fi}
\newenvironment{changedblock}{\begingroup\ifAIMHubReviewMode\color{red}\fi}{\endgroup}
